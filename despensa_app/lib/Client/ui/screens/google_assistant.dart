import 'package:despensaapp/Client/ui/widgets/basicCard.dart';
import 'package:despensaapp/Client/ui/widgets/carouselSelect.dart';
import 'package:despensaapp/Client/ui/widgets/simple_message.dart';
...
class _GoogleAssistant extends State<GoogleAssistant> {
  ...
  void Response(query) async {
    ...
    AuthGoogle authGoogle =
        await AuthGoogle(fileJson: "assets/despensa-app-a9c63-f07727095d53.json").build();
